class Chart < ActiveRecord::Base
  ...
  class << self
    ...
    def data_table_for_admin_chart(data_table, params)
    ...
    def result_for_users(objects, params)
      result = []
    ...
    def result_for_groups(objects, params)
      result = []
      days_for_iteration(params).map do |date|
        row = [date.to_s]
    ...
    def number_of_days(params)
      params[:time] == "week" ? WEEK_DAYS : MONTH_DAYS
    end

    def days_for_iteration(params)
